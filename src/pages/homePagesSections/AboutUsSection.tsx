  ...
  return (
    <Box
      ...
      sx={{
        ...
        position: "relative",
        overflow: "hidden",
        background: "linear-gradient(135deg, #1a0a2e 0%, #2d1b4e 50%, #3d2563 100%)",
        margin: 0,
        padding: 0,
      }}
    >
      ...
      <Box sx={{ maxWidth: "1400px", mx: "auto", px: { xs: 3, md: 6 } }}>
        ...
        <Box sx={{ textAlign: "center", mb: { xs: 6, md: 10 } }}>
          ...
          >
            ...
            >
              At Ghia Gym, we believe fitness is more than just physical transformation – 
              it's a lifestyle. We're dedicated to creating an inclusive environment where 
              everyone can pursue their fitness goals with confidence.
            </Typography>
          </motion.div>
        </Box>
